...
\begin{enumerate}[itemsep=0mm]
	...
	\item \lstinline|runtest profitScenario.txt| \\ 
		...
		Then you login as a manager to see different profits of the system,
		the time period is printed to the console.
	\item \lstinline|runtest targetScenario.txt| \\
		Set the fees according to the different targetpolicies. It first sets the target policy to
