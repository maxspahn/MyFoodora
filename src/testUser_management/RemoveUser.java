...
public class RemoveUser {
	...
	public void test() {
		...
		assertEquals(3,manFac.getManagerList().get(2).getMyFoodora().listUsers.size());
		
		// The CEO removes the new manager that has been created.
		manFac.getManagerList().get(0).removeUser("max3");
		assertEquals(2,manFac.getManagerList().get(2).getMyFoodora().listUsers.size());
		...
		assertEquals(3,manFac.getManagerList().get(0).getMyFoodora().listUsers.size());	
		...
		assertEquals(4,manFac.getManagerList().get(0).getMyFoodora().listUsers.size());	
		manFac.getManagerList().get(1).removeUser("McDonalds");
		assertEquals(3,manFac.getManagerList().get(0).getMyFoodora().listUsers.size());	
		
		// CEO removes a manager.
		manFac.getManagerList().get(0).removeUser("max4");
		assertEquals(2,manFac.getManagerList().get(0).getMyFoodora().listUsers.size());
